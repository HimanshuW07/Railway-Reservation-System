...
public class TrainModel {
	...
	public TrainModel(String trainNo, String trainName, String trainFrom, String trainTo, int fare, int seats,String date,
			String time) {
		super();
	...
	public String toString() {
		return "TrainModel [trainNo=" + trainNo + ", trainName=" + trainName + ", trainFrom="
				+ trainFrom + ", trainTo=" + trainTo + ", fare=" + fare + ", seats=" + seats + ", date=" + date + ", time=" + time + "]";
	}
